    ...
    //  console.log(checkToken)
     if (checkToken.id)
     {
        ...
        if (category == 'trending'){
            ...
            sqlQryForFeed = `SELECT post.id, post.content, post.user_id, post.content_type,post.created_on, post.content_url, users.username, users.full_name, users.image , COUNT(l.id) AS noOfLikes
            FROM post 
